...
config["gamma"] = 0.5                                                                  #fairness penalty weight
config["budget"] = 300
config['seed_nodes']=6
config['constraint_coeff_mu']=[0.5,0.8]                                                                  #number of edits									# Coeff of squared constraint
config["constraint_coeff_mu_update_factors"] = 1.01						# Update factor of Coeff of squared constraint
config["constraint_epoch_start_schedule"] = [1000,0,200]
